...
describe("E2E FPT: ", () => {
  ...
  it.only("Tutor with FP check is able to connect with a FP student", async () => {
    // create tutor
    ...
    await s.page.locator("label").filter({ hasText: "Microsoft Office" }).click();
    await s.struct.sessionRequest.nextArrow.click();
    ...
    await t.page.waitForTimeout(12000);
