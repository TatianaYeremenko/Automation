...
describe("Checking SDK GGPA integration: ", () => {
  ...
  it("Submit PA assigned tutoring request", async () => {
    ...
    await page
      .getByPlaceholder("API Key- required for Edulastic")
      .type("c6a413ac6ead8cde57aef4ce92688249");
    ...
    await page
      ...
      .type("Automation - submitting PA teacher request");
    await page
  ...
  it("Student receives PA teacher tutoring request and able to connect to a tutor", async () => {
    ...
    await t.struct.lessonSpace.sessionPlan
      .tutorGoals("Expressions & Equations")
      .waitForVisible();
